    ...
    return (
        <div className='card' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseExit}>
            <div className='card-container'>
                ...
                {props.downloadButton==true ?  < a href={"https://" + props.downloadLink} className='x'><img src="/Vector.png" width="15px"></img></a>:(cancelButton==true ? <div className='x' onClick={cancelSelection}>x</div> : <div></div>)}
